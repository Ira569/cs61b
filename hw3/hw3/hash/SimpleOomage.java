...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        return (this.green == that.green) && (this.red == that.red) && (this.blue == that.blue);
    }


    @Override
    public int hashCode() {// 1-255/5=51 1-51    1-51  100-5100
        if (!USE_PERFECT_HASH) {
            return red + green + blue;
        } else {
            // TODO: Write a perfect hash function for Simple Oomages.
            return red / 5 *100*100+green/5*100+blue/5;
        }
    }
